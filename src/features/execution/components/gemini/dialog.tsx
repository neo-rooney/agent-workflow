...
import { AVAILABLE_GEMINI_MODELS } from "@/configs/constants";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] flex flex-col overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Gemini 설정</DialogTitle>
          <DialogDescription>
            Gemini 노드에 대한 AI 모델과 프롬프트를 설정합니다.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Gemini 인증 정보</FormLabel>
                  <Select
